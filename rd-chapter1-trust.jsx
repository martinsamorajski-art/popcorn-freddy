...
const CH1_TRUST = {
  de: {
    ...
    included: [
      ...
      'Geeignet ab 8 Jahren (ab 6 gemeinsam mit euch)',
    ],
    ...
    faq: [
      ...
      { q: 'Für welches Alter ist es geeignet?', a: 'Empfohlen ab 8 Jahren – zum eigenständigen Entdecken. Baut und lest ihr gemeinsam, passt es schon ab 6 Jahren.' },
  ...
  en: {
    ...
    included: [
      ...
      'Suitable from age 8+ (6+ with a parent)',
    ],
    ...
    faq: [
      ...
      { q: 'What age is it suitable for?', a: 'Recommended from age 8 for independent explorers. From age 6 when you build and read it together.' },
