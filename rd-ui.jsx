  ...
  return (
    <div className="rd-suggest" role="dialog" aria-live="polite">
      ...
      <style>{`
        ...
        body:has(.rd-sticky.show) .rd-suggest, body:has(.shop-sticky.on) .rd-suggest { bottom: calc(env(safe-area-inset-bottom) + 96px); z-index: 54; transition: bottom .4s cubic-bezier(.22,.61,.36,1); }
