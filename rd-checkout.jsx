...
const RC_COPY = {
  de: {
    ...
    cart: {
      ...
      name_ph: 'z. B. Lukas',
      name_req: 'Bitte tragt den Namen des Kindes ein — er wird gedruckt und graviert.',
      box_label: (n) => `Box ${n}`,
  ...
  en: {
    ...
    cart: {
      ...
      name_ph: 'e.g. Lukas',
      name_req: 'Please enter the child’s name — it is printed and engraved.',
      box_label: (n) => `Box ${n}`,
