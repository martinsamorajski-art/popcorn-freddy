  ...
  de: {
    ...
    cart: {
      ...
      ded: {
        ...
        confirm: {
          title: 'Widmung so übernehmen?',
          body: 'Du hast den vorgeschlagenen Text nicht verändert. Möchtest du ihn unverändert ins Buch drucken lassen oder ihn noch persönlicher machen?',
          keep: 'So übernehmen',
  ...
  en: {
    ...
    cart: {
      ...
      ded: {
        ...
        confirm: {
          title: 'Keep this dedication?',
          body: "You haven't changed the suggested text. Would you like it printed in the book as it is, or make it more personal first?",
          keep: 'Keep as is',
          edit: 'Edit text',
        },
